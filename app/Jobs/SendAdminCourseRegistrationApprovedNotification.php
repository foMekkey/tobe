...
use App\Mail\AdminCourseRegistrationApproved;
use App\Setting;
...
class SendAdminCourseRegistrationApprovedNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($notificationEmail && !empty($notificationEmail->value)) {
            ...
            Mail::to($notificationEmail->value)
                ->send(new AdminCourseRegistrationApproved($this->registration, $this->adminName));
        }
    }
}
