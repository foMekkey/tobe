...
use Response;
use App\DataTables\TrainerSurveysDatatable;
...
{
    /**
     * @param TrainerSurveysDatatable $surveysDatatable
     * @return mixed
     */
    public function index($courseId, TrainerSurveysDatatable $surveysDatatable)
    {
        return $surveysDatatable->with('course_id', $courseId)->render('trainer.surveys.index', compact('courseId'));
    }
    ...
    {
        return view('trainer.surveys.create', compact('courseId'));
    }
    ...
    public function store($courseId, Request $request)
    {
        ...
        if ($survey) {
            ...
            if (count($questions)) {
                ...
                return redirect('trainer/surveys/' . $courseId)->with(['success' =>  __('pages.success-add')]);
            } else {
                $survey->delete();
    ...
    public function edit($courseId, $id)
    {
        ...
        return view('trainer.surveys.edit', compact('survey', 'questions', 'courseId', 'readonly'));
    }
    ...
    public function update(Request $request, $courseId, $id)
    {
        ...
        if ($hasAnswer) {
            ...
            return redirect('trainer/surveys/' . $courseId)->with(['success' =>  __('pages.success-edit')]);
        }
    ...
    public function results($courseId, $id)
    {
        ...
        return view('trainer.surveys.results',compact('survey', 'questions', 'answersPerQuestions', 'courseId', 'courseUsers'));
    }
}
