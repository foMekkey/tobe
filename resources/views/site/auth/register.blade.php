                ...
                <form action="{{ route('do-register') }}" method="post" id="registration_form">
                    @if (count($errors) > 0)
                        <div class="alert alert-danger alert-styled-right alert-arrow-right text-center bounceIn"
                            ...
                            <button type="button" class="close pull-left" data-dismiss="alert" aria-label="Close"><span
                                    aria-hidden="true" style="font-size: 35px;line-height: 53px;color: red;">×</span>
                            </button>
