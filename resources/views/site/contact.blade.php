                ...
                <form id="add_contact_form">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="{{ __('site.your_name') }}" name="name">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="{{ __('site.your_email') }}" name="email">
...
@section('scripts')
    <script>
        $('#add_contact_form').validate({rules: {
            name: 'required',
