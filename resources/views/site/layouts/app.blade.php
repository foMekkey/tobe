            ...
            <div class="row">
                ...
                <div class="right">
                    <ul class="list-inline social_icons">
                        ...
                        <li><a href="{{ $settings['instagram_link'] }}" target="_blank"><i
                                    class="fab fa-instagram"></i></a></li>
                        <li><a href="{{ $settings['youtube_link'] }}" target="_blank"><i
                                    class="fab fa-youtube"></i></a></li>
                        <li><a href="{{ $settings['twitter_link'] }}" target="_blank"><i
                                    class="fab fa-twitter"></i></a></li>
                        <li><a href="{{ $settings['facebook_link'] }}" target="_blank"><i
                    ...
                    <div class="navigation">
                        <div class="row">
                            <div class="col-md-2 col-sm-3 col-xs-8">
                                <a href="{{ url('site') }}" class="logo"><img
                                        src="{{ asset('site_assets') }}/images/logo.png"></a>
                            </div>
                            <div class="col-md-10 col-sm-9 col-xs-4">
                                ...
                                <nav class="navbar navbar-default overlay" id="myNav">
                                    <a href="javascript:void(0)" class="closebtn hidden-lg hidden-md"
                                        onclick="closeNav()">&times;</a>

                                    <h1 class="logo2 hidden-lg hidden-md"><img
                                            src="{{ asset('site_assets') }}/images/advice_logo.png"></h1>
                                    ...
                                    <ul class="list-inline nav-right">
                                        <li>
                                            ...
                                            @else
                                                ...
                                                <a href="{{ route('login') }}"
                                                    class="btn black_hover">{{ __('site.login') }}</a>
                                            @endif
                                        </li>
                                        <li class="search">
                                            ...
                                            <div class="search_sec">
                                                ...
                                                <a href="#" class="close_search"><span
                                    ...
                                    <ul class="nav navbar-nav overlay-content">
                                        <li><a href="{{ url('site') }}">{{ __('site.home') }}<img
                                                    src="{{ asset('site_assets') }}/images/advice_logo.png"></a></li>
                                        <li class="menu-item-has-children">
                                            <a href="#">{{ __('site.know') }}<img
                                                    src="{{ asset('site_assets') }}/images/advice_logo.png"></a>
                                            <span class="fa fa-caret-down"></span>

                                            <ul class="sub-menu">
                                                @foreach ($settings['know_pages'] as $pageLink)
                                                    <li><a
                                                            href="{{ url('site/page') . '/' . $pageLink->key }}">{{ $pageLink->title }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="#">{{ __('site.discover') }}<img
                                                    src="{{ asset('site_assets') }}/images/advice_logo.png"></a>
                                            <span class="fa fa-caret-down"></span>
                                        ...
                                        <li><a href="{{ url('site/blog') }}">{{ __('site.blog') }}<img
                                                    src="{{ asset('site_assets') }}/images/advice_logo.png"></a></li>
        ...
        <div class="container-fluid">
            <div class="Subscribe wow zoomIn">
                ...
                <form id="add_newsletter_form">
                    ...
                    <div id="add_newsletter-alert" class="alert alert-success" role="alert" style="display: none">
                    </div>
                    @csrf
                    <input type="submit" class="btn black_hover" value="{{ __('site.subscribe_us') }}"
                        id="add_newsletter">
                </form>
            </div>
        </div><!-- Subscribe -->
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            ...
                            <ul class="info_list">
                                ...
                                <li><i
                                        class="fas fa-map-marker-alt"></i>{{ $settings['address_' . app()->getLocale()] }}
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="middle">
                                ...
                                <div class="links">
                                    ...
                                    <ul>
                                        ...
                                        <li><a
                                                href="{{ url('site/page/privacy_policy') }}">{{ __('site.privacy_policy') }}</a>
                                        </li>
                                ...
                                @foreach ($settings['blog'] as $settingBlog)
                                    <div class="news_block">
                                        <a href="{{ url('site/blog/' . $settingBlog->id) }}">
                                            <img
                                                src="{{ config('filesystems.disks.contabo.url') . '/' . $settingBlog->image }}">
                                            <div>
                                                <h4>{{ $settingBlog->title }}</h4>
                                                <p>{{ \Carbon\Carbon::parse($settingBlog->date)->format('M j, Y') }}
                                                </p>
                                            </div>
                                        </a>
                                    </div>
