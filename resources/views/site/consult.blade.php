...
@section('styles')
    ...
    <style>
        ...
        /* اختياري: إزالة الأسهم بتاعت الساعات/الدقايق */
                ...
                <form id="add_consult_form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input type="text" class="form-control datepicker" placeholder="{{ __('site.date') }}"
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group" style="position: relative;">
                            <input type="time" class="form-control" placeholder="{{ __('site.hours') }}" name="hours"
                                id="hours">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input type="file" name="file" class="form-control"
                                placeholder="{{ __('site.upload_file') }}"
                                style="padding-top: 20px;padding-left: 50px;cursor: pointer;">
                            <span class="fa fa-upload"></span>
                            <i
                                style="position: absolute;width:92px;height: 58px;line-height: 62px;top: 1px;{{ __('site.left') }}: 50px; background-color: #fff;color: #979797;">{{ __('site.upload_file') }}</i>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        // لما يضغط على الايقونة
        clockIcon.addEventListener('click', function() {
            hoursInput.showPicker?.(); // لمتصفحات حديثة
            hoursInput.focus(); // fallback
        });

        // لما يضغط على الـ input نفسه
        hoursInput.addEventListener('click', function() {
            hoursInput.showPicker?.();
        });
        $('#add_consult_form').validate({
            rules: {
                date: 'required',
                hours: 'required',
