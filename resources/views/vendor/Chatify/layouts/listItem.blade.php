        ...
        <tr data-action="0">
            ...
            <td>
                <p data-id="{{ $user->id }}" data-type="user">
                    {{ isset($user->user_name) ? (strlen($user->user_name) > 12 ? trim(substr($user->user_name, 0, 12)) . '..' : $user->user_name) : (strlen($user->name) > 12 ? trim(substr($user->name, 0, 12)) . '..' : $user->name) }}
                </p>
                <span>
                    {{ isset($user->f_name) && isset($user->l_name) ? $user->f_name . ' ' . $user->l_name : '' }}
                </span>
            </td>
        </tr>
    </table>
