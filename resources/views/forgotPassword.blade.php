...
@endif
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <h5 class="register">ليس لديك حساب ؟<a href="{{ url('/signup') }}">سجل حساب</a></h5>
                    <h5 class="register" style="margin-top: 15px;"><a href="{{ url('/login') }}" style="color: #000;">تسجيل الدخول</a></h5>
