...
@section('content')
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            <form action="{{ route('postupdatecoursesTrainer', ['id' => $courses->id]) }}" method="post" id="kt_form_1"
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.profile') }}
                                                <span style="color: red">*</span></label>
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle"
                                                    id="kt_apps_user_add_avatar">
                                                    <div class="kt-avatar__holder" id="imagePreview"
                                                        style="background-image: url('{{ config('filesystems.disks.contabo.url') . '/' . $courses->image }}');">
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.course-name') }}
                                                <span style="color: red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control" name="name" type="text"
                                                    value="{{ $courses->name ? $courses->name : old('name') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.category') }}
                                                <span style="color: red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <select class="form-control" name="level">
                                                    ...
                                                    @for ($i = 1; $i <= 12; $i++)
                                                        <option value="{{ $i }}"
                                                            @if ($courses->level == $i) selected @endif>
                                                            {{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.desc') }} <span
                                                    style="color: red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea class="form-control" name="desc" id="exampleTextarea" rows="3" spellcheck="false">{{ $courses->desc }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                {{ __('pages.content') }}</label>
                                            <div class="col-lg-9 col-xl-9">
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-xl-3 col-lg-3 col-form-label">{{ __('pages.data-start-and-end') }}<span
                                                    style="color: red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.period_type') }}
                                                <span style="color: red">*</span></label>
                                            <div class="col-lg-3 col-xl-3">
                                                <select name="period_type" class="form-control" id="period_type">
                                                    <option value="hour"
                                                        @if ($courses->period_type == 'hour') selected='selected' @endif>
                                                        {{ __('pages.hour') }}</option>
                                                    <option value="day"
                                                        @if ($courses->period_type == 'day') selected='selected' @endif>
                                                        {{ __('pages.day') }}</option>
                                                    <option value="week"
                                                        @if ($courses->period_type == 'week') selected='selected' @endif>
                                                        {{ __('pages.week') }}</option>
                                                    <option value="month"
                                                        @if ($courses->period_type == 'month') selected='selected' @endif>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                {{ __('pages.rules_of_achievement') }}</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea class="form-control" name="complete_rules" rows="3" spellcheck="false">{{ $courses->complete_rules }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" name="tags" class="form-control"
                                                    value="{{ $courses->tags }}" data-role="tagsinput" />
                                            </div>
                                        </div>
