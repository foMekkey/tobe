                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('addlessonsTrainer',['id' => $courseData->id]) }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                ...
                                @if($l->type == 1)
                                    <a href="#" class="course_link">
                                        ...
                                        <div class="link_left" style="display: inherit">
                                            <form action="{{ route('getupdatelessonsTrainer',['course_id'=>$courseData->id ,'lesson_id'=>$l->id]) }}">
