...
@section('page-main-title', __('pages.missions'))
@section('page-main-url', route('TrainerMissions') )
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('addmissionsTrainer') }}" class="btn btn-brand btn-elevate btn-icon-sm">
