...
@section('content')
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('postupdatelessonsTrainer',['course_id'=>$course_id ,'lesson_id'=>$lesson->id]) }}" enctype="multipart/form-data">
                @csrf
