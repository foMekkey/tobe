                                            ...
                                            <div class="kt-section__body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9" style="margin-top: 10px;">
                                                        <label for="check1">
                                                            <input type="radio" name="meeting_with" value="1" id="check1" checked class="icheck"> {{ __('pages.Student') }} </label>
                                                        <label for="check2">
                                                            <input type="radio" name="meeting_with" value="2" id="check2" class="icheck"> {{ __('pages.group') }} </label>
                                                    </div>
                                                </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('input[type=radio][name=meeting_with]').change(function() {
                if (this.value == '1') {
                    $('#group_id').hide();
                    $('#student_id').show();
                }
