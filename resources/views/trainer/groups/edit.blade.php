            ...
            <div class="tab-content">
                    <div class="tab-pane active" id="kt_apps_user_edit_tab_1" role="tabpanel">
                        <div class="kt-form kt-form--label-right">
                            <form action="{{ route('postupdategroupsTrainer',['id'=>$groups->id]) }}" id="kt_form_1" method="post">
                                @csrf
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.name-group') }} <span style="color: red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control" name="name"  type="text" value="{{ ($groups->name) ? $groups->name  : old('name') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea class="form-control" name="desc" id="exampleTextarea" rows="3" spellcheck="false">{{ ($groups->desc) ? $groups->desc  : old('desc') }}</textarea>                                                        </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">{{ __('pages.group-key') }}</label>
                                            <div class="col-lg-9 col-xl-9">

                                                <input class="form-control" name="key" type="text" readonly value="{{ ($groups->key) ? $groups->key  : old('key') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" name="tags" class="form-control" value="{{ $groups->tags }}" data-role="tagsinput" />
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <div class="kt-checkbox-single">
                                                    <label class="kt-checkbox">
                                                        <input type="checkbox" name="status" value="1" @if($groups->status == 1) checked @endif>
                                                        <span></span>
                                                    </label>
                                                </div>
                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="form-group row">
                                    ...
                                    <form method="post" action="{{ route('postaddgroupsfileTrainer',['group_id'=>$groups->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div id="drop-area">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">  {{ __('pages.name-file') }} <span style="color: red">*</span></label>
                    <div class="col-lg-9 col-xl-9">
    ...
    <script>
        ...
        $(function() {
            $('#userGroups').DataTable({
                ...
                searching: true,
                serverSide: true,
                ajax: '{!! url('trainer/groups/datatable-users/') !!}' + '/' + groups,
                "language": {
    ...
    <script>
        ...
        $(function() {
            $('#courseGroups').DataTable({
                ...
                searching: true,
                serverSide: true,
                ajax: '{!! url('trainer/groups/datatable-courses/') !!}' + '/' + groups,
                "language": {
                    "url": "{{ asset('ar-datatable.json')  }}"
                },
                columns: [
                    ...
                    { data: 'category_id', name: 'category_id','title':'الفئة' },
                    { data: 'options', name: 'options' ,'title':'العمليات' },
                ],
            });
        });
    ...
    <script>
        ...
        $(function() {
            $('#userFiles').DataTable({
                ...
                searching: true,
                serverSide: true,
                ajax: '{!! url('trainer/groups/datatable-files/') !!}' + '/' + groups,
                "language": {
                    "url": "{{ asset('ar-datatable.json')  }}"
                },
                columns: [
