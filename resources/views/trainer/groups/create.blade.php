            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('postaddgroupsTrainer') }}" enctype="multipart/form-data">
                           {{ csrf_field() }}
                                        ...
                                        <div class="col-xl-12">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <textarea  class="form-control" name="desc" id="exampleTextarea" rows="3" spellcheck="false"></textarea>                                                        </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.group-key') }}  </label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control" name="key" type="text" readonly value="{{ mt_rand(100000,999999) }}">
                                                    </div>
                                                </div>
