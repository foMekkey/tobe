                ...
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post"
                              action="{{ route('storediscussionTrainer') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="kt-wizard-v4__content" data-ktwizard-type="step-content"
                                ...
                                <div class="kt-portlet__head kt-portlet__head--lg" style="">
                                    <div class="kt-portlet__head-label">
                                        <h2 class="kt-portlet__head-title">{{ __('pages.add-discussions') }}</h2>
                                    </div>
                                </div>
                                            ...
                                            <div class="kt-section__body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5 col-xl-5">
                                                        <input class="form-control" name="title" type="text" value="{{ old('name') }}" placeholder="{{ __('pages.subject') }}" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <textarea class="form-control" name="body" id="exampleTextarea" placeholder="{{ __('pages.message') }}" rows="7" spellcheck="false" required=""></textarea></div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-lg-3 col-xl-3">{{ __('pages.cources-list') }}</label>
                                                    <div class="col-lg-9 col-xl-9">
