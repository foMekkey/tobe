    ...
    <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('cohorts.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addCommunityModalLabel">إضافة مجتمع للفوج</h5>
                    ...
                    <form id="addCommunityForm" method="POST" action="{{ route('community.store') }}"
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="reference_id" id="cohort_id">
        ...
        <div class="modal fade" id="editCommunityModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editCommunityModalLabel">تعديل مجتمع الفوج</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    success: function(data) {
                        ...
                        if (data.cover_image) {
                            $('#current_image_container').html(
                                '<img src="{{ config('filesystems.disks.contabo.url') }}' +
                                data.cover_image +
