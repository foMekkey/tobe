                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="course_detail">
                        ...
                        <div class="course_subscribe">
                            ...
                            @if(!$courseUser)
                                <div class="course_info">
                                    <a href="javascript:void(0)" class="btn black_hover join_course">{{ __('site.subscribe') }}</a>
                                </div>
                            @endif
                    ...
                    @if($courseUser)
                        @foreach ($courseSurveys as $survey)
                            <a href="{{ route('showSurveysStudent', $survey->id) }}">
                                <img class="img-fluid mb-3" src="{{ asset('admin/assets') }}/{{ $survey->is_day_star ? 'day_star.jpg' : 'survey_icon.jpg' }}" />
                            </a>
                        @endforeach
    ...
    <script>
        ...
        $('.join_course').click(function(event) {
            ...
            $.ajax({
                ...
                data: {'_token': "{{ csrf_token() }}", 'id': {{ $course->id }}},
