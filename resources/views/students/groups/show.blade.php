                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control" name="name"  type="text" value="{{ ($groups->name) ? $groups->name  : old('name') }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea class="form-control" name="desc" id="exampleTextarea" rows="3" spellcheck="false" disabled>{{ ($groups->desc) ? $groups->desc  : old('desc') }}</textarea>                                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                ...
                                                <input class="form-control" name="key" type="text" readonly value="{{ ($groups->key) ? $groups->key  : old('key') }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" name="tags" class="form-control" value="{{ $groups->tags }}" data-role="tagsinput" disabled />
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <div class="kt-checkbox-single">
                                                    <label class="kt-checkbox">
                                                        <input type="checkbox" name="status" value="1" @if($groups->status == 1) checked @endif disabled>
                                                        <span></span>
                                                    </label>
                                                </div>
