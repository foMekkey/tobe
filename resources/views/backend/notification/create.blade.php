            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('postaddnotifications') }}" enctype="multipart/form-data">
                             @csrf
                            ...
                            <div class="kt-wizard-v4__content" data-ktwizard-type="step-content"
                                ...
                                <div class="kt-portlet__head kt-portlet__head--lg" style="">
                                    <div class="kt-portlet__head-label">
                                        <h2 class="kt-portlet__head-title">{{ __('pages.add-new-notification') }} </h2>
                                    </div>
                                </div>
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.event') }}  <span style="color: red">*</span></label>
                                                            <div class="col-lg-9 col-xl-9">

                                                                {{Form::select('notifications_event_id',$events,null,['class'=>'form-control','placeholder'=> __('pages.choose-event'), 'required'=>'required'])}}
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">{{ __('pages.reciver') }} <span style="color: red">*</span></label>
                                                    <div class=" col-lg-9 col-md-9 ">
                                                        <select  class="form-control kt-select2" id="kt_select2" name="notifier">
                                                            <option value="0" selected> {{ __('pages.choose-reciver') }}</option>
                                                            @foreach($recivers as $key=>$reciver)
                                                                <option value="{{ $key }}">{{ $reciver }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <textarea  class="form-control" name="notification" id="exampleTextarea" rows="3" spellcheck="false"></textarea>
                                                    </div>
