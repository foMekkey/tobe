...
@section('content')
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            <form action="{{ route('postupdatepages',['id'=>$page->id]) }}" method="post" id="kt_form_1" enctype="multipart/form-data">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <input class="form-control" name="title" type="text" value="{{ ($page->title) ? $page->title  : old('title') }}">
                        </div>
                    </div>
