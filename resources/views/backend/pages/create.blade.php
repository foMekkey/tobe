            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        {{ __('pages.add-new-page') }}
                    </h3>
                </div>
            </div>

            <!--begin::Form-->
            <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('postaddpages') }}" enctype="multipart/form-data">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">{{ __('pages.page-name') }}     <span style="color: red">*</span></label>
                        <div class="col-lg-9 col-xl-9">
