...
@section('page-main-title', __('pages.testimonials'))
@section('page-main-url', route('testimonials'))
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('addtestimonials') }}" class="btn btn-brand btn-elevate btn-icon-sm">
