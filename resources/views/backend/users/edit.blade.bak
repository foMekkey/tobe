    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            <div class="tab-content">
                ...
                <form action="{{ route('postupdateuser' , ['id'=>$users->id]) }}" id="kt_form_1" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="kt-form__body">
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <div id="certificates-container" class="form-group row" @if($users->type != 3) style="display: none" @endif>
                                        <label class="col-xl-3 col-lg-3 col-form-label">  {{ __('pages.certificates') }} </label>
                                        <div class="col-lg-9 col-xl-9">
                                            <textarea class="form-control" id="certificates" name="certificates" rows="3" spellcheck="false">{{ $users->certificates }}</textarea></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label"> {{ __('pages.tag') }} </label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="tags" class="form-control" value="{{ $users->tags }}" data-role="tagsinput" />
                                        </div>
                                    </div>
