...
@section('page-main-url', route('Surveys', $courseId) )
    ...
    <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('addsurveys', $courseId) }}" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        <div class="kt-portlet__body">
            <ul class="nav nav-pills nav-fill" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('courses/show-all/' . $courseId) }}#kt_tabs_5_1">{{ __('pages.Content') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('courses/show-all/' . $courseId) }}#kt_tabs_5_2">{{ __('pages.users_and_progress') }}</a>
                </li>
                <li class="nav-item">
