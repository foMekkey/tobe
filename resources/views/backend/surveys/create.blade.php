...
@section('content')
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--label-right" id="kt_form_1" method="post" action="{{ route('postaddsurveys', $courseId) }}">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row" style="display: none;">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <input type='text' class="form-control" id="datepickerr" readonly placeholder="" name="date" value="{{ Carbon\Carbon::now()->format('m/d/Y') }}"/>
                        </div>
                    </div>
                    <div class="form-group row">
