...
@section('page-main-title', __('pages.faqs'))
@section('page-main-url', route('faqs'))
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-label">
                <ul id="myTab" class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('faqs') }}">
                            <h5>{{ __('pages.faqs') }}</h5>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('addfaq') }}" class="btn btn-brand btn-elevate btn-icon-sm">
