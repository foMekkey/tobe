                                ...
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__section" style="width: 100%;">
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-2">{{ __('pages.site_settings.' . $setting->name) }}<span style="color: red">*</span></label>
                                            <div class="col-md-{{ $setting->type == 'textarea' || $setting->type == 'html' ? 10 : 5 }}">
                                                @if($setting->type == 'text' || $setting->type == 'number')
                                                    <input type="{{ $setting->type }}" value="{{ $setting->value }}" name="{{ $setting->name }}" class="form-control" placeholder="" required="">
