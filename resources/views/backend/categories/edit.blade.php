...
@section('content')
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            <form action="{{ route('postupdatecategories',['id'=>$categories->id]) }}" id="kt_form_1" method="post" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <select class="form-control"  name="lang" >
                                                    <option value="ar" @if($categories->lang == 'ar')selected @endif> {{ __('pages.language-ar') }} </option>
                                                    <option value="en" @if($categories->lang == 'en')selected @endif> {{ __('pages.language-en') }} </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input  class="form-control" name="name" type="text" value="{{ ($categories->name) ? $categories->name  : old('name') }}">
                                            </div>
                                        </div>
