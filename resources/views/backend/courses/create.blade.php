                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <select name="period_type" class="form-control" id="period_type">
                                    <option value="hour">{{__('pages.hour')}}</option>
                                    <option value="day">{{__('pages.day')}}</option>
                                    <option value="week">{{__('pages.week')}}</option>
                                    <option value="month">{{__('pages.month')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
