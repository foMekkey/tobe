...
@section('content')
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            <form action="{{ route('postupdatecourses',['id'=>$courses->id]) }}" method="post" id="kt_form_1" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <select class="form-control"  name="lang" >
                                                    <option value="ar" @if($courses->lang == 'ar')selected @endif> {{ __('pages.language-ar') }} </option>
                                                    <option value="en" @if($courses->lang == 'en')selected @endif> {{ __('pages.language-en') }} </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-3 col-xl-3">
                                                <select name="period_type" class="form-control" id="period_type">
                                                    ...
                                                    <option value="month" @if ( $courses->period_type == 'month') selected='selected' @endif>{{ __('pages.month') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        </div>
...
@section('script')
    ...
    <script>
        ...
        @if(checkPermission('DatatableUsersCourses'))
          $(function() {
            $('#userCourses').DataTable({
                processing: true,
                searching: true,
                serverSide: true,
                ajax: '{!! url('courses/datatable-users/') !!}' + '/' + courses,
                "language": {
    ...
    <script>
        ...
        $(function() {
            $('#groupsCourses').DataTable({
                ...
                searching: true,
                serverSide: true,
                ajax: '{!! url('courses/datatable-groups/') !!}' + '/' + courses,
                "language": {
                    "url": "{{ asset('ar-datatable.json')  }}"
                },
                columns: [
