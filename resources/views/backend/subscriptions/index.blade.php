...
@section('page-main-title', __('pages.subscriptions'))
@section('page-main-url', route('subscriptions') )
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            ...
                            <a href="{{ route('addsubscription') }}" class="btn btn-brand btn-elevate btn-icon-sm">
