                    ...
                    <div class="course_content">
                        <div class="course_content-heading">
                            ...
                            <div class="desc">
                                ...
                                <h2>{{ __('pages.time_period') }}: <span>{{ $courseData->duration }} {{ __('pages.weeks') }}</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                @if($l->type == 1)
                                    <a href="#" class="course_link">
                                        <div class="link_right">
                                            <h2>
                                                <svg xmlns="//www.w3.org/2000/svg" xmlns:xlink="//www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                ...
                                @else
                                    <a href="#" class="course_link">
                                        <div class="link_right">
                                            <h2>
                                                <svg xmlns="//www.w3.org/2000/svg" xmlns:xlink="//www.w3.org/1999/xlink" width="25px" height="25px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect id="bound" x="0" y="0" width="24" height="24"/>
