                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            <p style="margin: 0 0 15px; font-size: 16px; line-height: 1.6;">مرحباً
                                {{ $contactMessage->name }}،</p>
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">نشكرك على تواصلك معنا. نود
                                إعلامك بأننا استلمنا رسالتك وسوف يتم الرد عليها من قبل فريقنا في أقرب وقت ممكن.</p>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 15px 0 5px;">
                                                    <strong style="font-size: 15px; color: #555;">رسالتك:</strong>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">إذا كان لديك أي استفسارات
                                إضافية، فلا تتردد في التواصل معنا مرة أخرى.</p>
