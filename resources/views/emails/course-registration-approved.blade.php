...
<head>
    ...
    <title>تم قبول طلب الانضمام للدورة</title>
</head>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="padding: 30px 40px 0;">
                            <h1 style="margin: 0; font-size: 24px; color: #333; font-weight: 600; text-align: center;">
                                تم قبول طلب الانضمام للدورة!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">يسرنا إعلامك بأنه تم قبول
                                طلبك للانضمام إلى دورة "{{ $registration->course->name ?? 'الدورة المطلوبة' }}". نرحب بك
                                في هذه الرحلة التعليمية ونتمنى لك تجربة مثمرة ومفيدة.</p>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    ...
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $registration->course->name ?? 'الدورة المطلوبة' }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    ...
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $registration->cohort->name ?? 'الفوج المحدد' }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    <strong style="font-size: 15px; color: #555;">تاريخ البدء:</strong>
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $registration->cohort->start_date ?? now()->format('Y-m-d') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    ...
                                                    <span
                                                        style="font-size: 15px; color: #28a745; margin-right: 5px; font-weight: bold;">تم
                                                        القبول</span>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6; text-align: center;">يمكنك
                                الآن الوصول إلى محتوى الدورة من خلال تسجيل الدخول إلى حسابك:</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="{{ $loginUrl }}"
                                            style="display: inline-block; padding: 12px 30px; background-color: #D4AF37; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px; transition: background-color 0.3s;">تسجيل
                                            الدخول</a>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin: 30px 0 0; font-size: 16px; line-height: 1.6;">نتطلع إلى رؤيتك في الدورة!
                            </p>
