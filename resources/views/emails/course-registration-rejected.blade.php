...
<head>
    ...
    <title>تم رفض طلب الانضمام للدورة</title>
</head>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">نأسف لإعلامك بأنه تم رفض
                                طلبك للانضمام إلى دورة "{{ $registration->course->name ?? 'الدورة المطلوبة' }}".</p>
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    <strong style="font-size: 15px; color: #555;">تاريخ
                                                        التقديم:</strong>
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $registration->created_at->format('Y-m-d') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">نشكرك على اهتمامك بدوراتنا.
                                يمكنك التقديم مرة أخرى في دورات أخرى أو في أوقات لاحقة.</p>

                            <p style="margin: 30px 0 0; font-size: 16px; line-height: 1.6;">إذا كان لديك أي استفسارات،
