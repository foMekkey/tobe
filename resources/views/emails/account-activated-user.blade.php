...
<head>
    ...
    <title>تم تفعيل حسابك بنجاح</title>
</head>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            <p style="margin: 0 0 15px; font-size: 16px; line-height: 1.6;">مرحباً {{ $user->f_name }}،
                            </p>
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">نود إعلامك بأنه تم تفعيل
                                حسابك بنجاح في {{ config('app.name') }}. يمكنك الآن تسجيل الدخول واستخدام جميع ميزات
                                المنصة.</p>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    ...
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $user->f_name }}
                                                        {{ $user->l_name }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    <strong style="font-size: 15px; color: #555;">البريد
                                                        الإلكتروني:</strong>
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $user->email }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <strong style="font-size: 15px; color: #555;">تاريخ
                                                        التفعيل:</strong>
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $user->email_verified_at->format('Y-m-d H:i') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6; text-align: center;">يمكنك
                                الآن تسجيل الدخول إلى حسابك من خلال الرابط أدناه:</p>
                            ...
                            <p style="margin: 30px 0 0; font-size: 16px; line-height: 1.6;">نتطلع إلى رؤيتك في منصتنا!
                            </p>
