                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">تم تفعيل حساب مستخدم في
                                النظام. فيما يلي تفاصيل المستخدم:</p>
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    <strong style="font-size: 15px; color: #555;">تاريخ
                                                        التسجيل:</strong>
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">{{ $user->created_at->format('Y-m-d H:i') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6; text-align: center;">يمكنك
                                الوصول إلى صفحة المستخدم من خلال الرابط أدناه:</p>
