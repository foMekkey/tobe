...
<head>
    ...
    <title>تأكيد استلام طلب الانضمام للدورة</title>
</head>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="padding: 30px 40px 0;">
                            <h1 style="margin: 0; font-size: 24px; color: #333; font-weight: 600; text-align: center;">
                                تأكيد استلام طلب الانضمام للدورة</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">نشكرك على تقديم طلب الانضمام
                                للدورة. نود إعلامك بأننا استلمنا طلبك وهو الآن قيد المراجعة من قبل فريقنا.</p>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                                    <strong style="font-size: 15px; color: #555;">رقم الطلب:</strong>
                                                    <span
                                                        style="font-size: 15px; color: #333; margin-right: 5px;">#{{ $registration->id }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eaeaea;">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    ...
                                                    <span
                                                        style="font-size: 15px; color: #FF7F00; margin-right: 5px; font-weight: bold;">قيد
                                                        المراجعة</span>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">سيتم إعلامك بأي تغيير في
                                حالة طلبك عبر البريد الإلكتروني. يمكنك أيضًا متابعة حالة طلبك من خلال حسابك الشخصي على
                                المنصة.</p>
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6;">إذا كان لديك أي استفسارات،
                                فلا تتردد في التواصل معنا.</p>

                            <p style="margin: 30px 0 0; font-size: 16px; line-height: 1.6;">نشكرك على اهتمامك،</p>
